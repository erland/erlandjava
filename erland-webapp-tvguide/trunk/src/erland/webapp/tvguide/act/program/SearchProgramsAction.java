...
import erland.webapp.tvguide.fb.program.SelectProgramFB;
...
public class SearchProgramsAction extends BaseAction {
    ...
    protected void executeLogic(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        SelectProgramFB fb = (SelectProgramFB) form;
        ...
        request.setAttribute("programsPB",getPrograms(username,fb));
    }

    protected ProgramPB[] getPrograms(String username, SelectProgramFB fb) {
        ...
        if(entities.length>0) {
            ...
            System.out.println("channels.length = "+entities.length);
            ...
            System.out.println("programs.length = "+entities.length);
            for (int i = 0; i < entities.length; i++) {

...
<div class="propertypage-title"><bean:message key="tvguide.subscription.edit.windowtitle"/></div>
<erland-common:helplink style="propertypage-button" context="subscription.edit" target="_blank"><bean:message key="tvguide.help.button"/></erland-common:helplink>
<tiles:insert page="/WEB-INF/tiles/common/validationerrors.jsp" />
<html:form action="/user/editsubscription" method="POST">
    <logic:notEmpty name="editSubscriptionFB" property="idDisplay">

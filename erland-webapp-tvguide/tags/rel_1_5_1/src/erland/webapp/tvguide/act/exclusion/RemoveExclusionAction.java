...
public class RemoveExclusionAction extends BaseAction {
    protected void executeLogic(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if(exclusion!=null && exclusion.getUsername().equals(request.getRemoteUser())) {
            getEnvironment().getEntityStorageFactory().getStorage("tvguide-exclusion").delete(template);
        }
    }
}

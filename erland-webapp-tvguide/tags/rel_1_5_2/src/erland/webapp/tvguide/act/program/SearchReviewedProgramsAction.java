...
public class SearchReviewedProgramsAction extends SearchMinReviewProgramsAction {
    /**
     * Logging instance
     */
    private static Log LOG = LogFactory.getLog(SearchReviewedProgramsAction.class);

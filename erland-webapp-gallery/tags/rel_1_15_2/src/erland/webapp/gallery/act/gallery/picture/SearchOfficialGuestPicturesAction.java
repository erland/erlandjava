...
public class SearchOfficialGuestPicturesAction extends SearchPicturesAction {
    public final static String OFFICIAL = SearchOfficialGuestPicturesAction.class + "-official";
    ...
    protected String getAllFilter(HttpServletRequest request) {
        if (getOfficial(request).booleanValue()) {
            return getOfficialFilterPrefix()+"forgallery";
        } else {
    ...
    protected String getCategoryTreeFilter(HttpServletRequest request) {
        if (getOfficial(request).booleanValue()) {
            return getOfficialFilterPrefix()+"forgalleryandcategorylist";
        } else {

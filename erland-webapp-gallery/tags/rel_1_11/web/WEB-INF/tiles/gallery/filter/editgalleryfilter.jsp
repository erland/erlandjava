...
<div class="propertypage-title"><bean:message key="gallery.gallery.galleryfilter.edit.title"/></div>
<erland-common:helplink style="propertypage-button" context="gallery.galleryfilter.edit" target="_blank"><bean:message key="gallery.help.button"/></erland-common:helplink>

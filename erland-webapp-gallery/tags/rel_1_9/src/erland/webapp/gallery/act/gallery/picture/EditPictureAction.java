...
public class EditPictureAction extends BaseAction {
    protected void executeLogic(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        Picture picture = (Picture) getEnvironment().getEntityFactory().create("gallery-picture");
        PropertyUtils.copyProperties(picture, fb);
        picture.setGallery(gallery);
        getEnvironment().getEntityStorageFactory().getStorage("gallery-picture").store(picture);

...
<table width="600" class="picturepage-body">
    ...
    <erland-common:tablegrid name="picturesPB" property="pictures" id="picture" valign="bottom" align="center" nameRowsCols="galleryPB" colsProperty="noOfCols" rowsProperty="noOfRows" rowIterationsProperty="noOfThumnailInfoRows" tableStyle="picturepage-pictures-body" cellStyle="picturepage-picture-cell" rowStyle="picturepage-picture-row" width="100%">

...
<div class="propertypage-title"><bean:message key="gallery.picturestorage.edit.title"/></div>
<erland-common:helplink style="propertypage-button" context="picturestorage.edit" target="_blank"><bean:message key="gallery.help.button"/></erland-common:helplink>

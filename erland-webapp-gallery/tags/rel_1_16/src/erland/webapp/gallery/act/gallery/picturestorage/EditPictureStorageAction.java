...
public class EditPictureStorageAction extends BaseAction {
    protected void executeLogic(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        storage.setUsername(request.getRemoteUser());
        getEnvironment().getEntityStorageFactory().getStorage("gallery-picturestorage").store(storage);
    }
}
...
public class ImportHelper {
    ...
    private static WebAppEnvironmentInterface getEnvironment() {
        return WebAppEnvironmentPlugin.getEnvironment();
    }
    public static void clearCategories(Integer galleryId) {
    ...
    public static void clearPictures(Integer galleryId) {
        QueryFilter filter = new QueryFilter("allforgallery");
        filter.setAttribute("gallery", galleryId);
    ...
    public static Integer createCategory(Map previousCategories, Integer gallery, String categoryPath) {
    ...
    public static void loadCategories(Map categories, Integer gallery) {
        QueryFilter filter = new QueryFilter("allforgallery");
        filter.setAttribute("gallery", gallery);
        categories.clear();
    ...
    private static boolean addCategory(Map categories, Category category) {
    ...
    public static void createPictureAssociation(Integer gallery, Integer picture, Integer category) {

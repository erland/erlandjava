...
<html:form action="/user/quicksetup2" method="POST">
    ...
    <table class="propertypage-body">
        ...
        <tr><td><bean:message key="gallery.gallery.quicksetup.official-category"/></td><td>
        <html:select property="officialCategoryDisplay" size="1">
            <html:option value="" key="gallery.gallery.quicksetup.official-category.none"/>
            <html:options collection="categoriesPB" property="categoryDisplay" labelProperty="name" />
        </html:select>
        </td></tr>
        <tr><td><bean:message key="gallery.gallery.quicksetup.officialguest-category"/></td><td>
        <html:select property="officialGuestCategoryDisplay" size="1">
            <html:option value="" key="gallery.gallery.quicksetup.officialguest-category.none"/>
            <html:options collection="categoriesPB" property="categoryDisplay" labelProperty="name" />
        </html:select>
        </td></tr>

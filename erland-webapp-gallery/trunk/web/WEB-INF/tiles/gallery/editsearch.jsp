...
<html:form action="/user/viewsearchpictures" method="POST">
    ...
    <table>
    <tr><td><bean:message key="gallery.search.first-date"/></td><td>
    <html:text property="dateAfterDisplay"/>
    </td></tr>
    <tr><td><bean:message key="gallery.search.last-date"/></td><td>
    <html:text property="dateBeforeDisplay"/>
    </td></tr>
    <tr><td><bean:message key="gallery.search.categories"/></td><td>
    ...
    <tr><td><bean:message key="gallery.search.all-categories"/></td><td>

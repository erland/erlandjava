...
<bean:message key="gallery.account.new.new-user-created"/>
<table class="propertypage-body">
    <tr>
    <td><bean:message key="gallery.account.new.username"/></td>
    <td><bean:write name="accountPB" property="username"/></td>
    </tr>
    <tr>
    <td><bean:message key="gallery.account.new.firstname"/></td>
    <td><bean:write name="accountPB" property="firstName"/></td>
    </tr>
    <tr>
    <td><bean:message key="gallery.account.new.lastname"/></td>
    <td><bean:write name="accountPB" property="lastName"/></td>
    </tr>
</table>
<bean:message key="gallery.account.new.login-message"/>

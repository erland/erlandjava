...
public class RequestParameterSwitchAction extends BaseAction {
    protected ActionForward findSuccess(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        String value = ServletParameterHelper.replaceDynamicParameters(parameter,request.getParameterMap());

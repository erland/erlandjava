...
<table border="0">
    <logic:iterate name="purchaseEntriesPB" id="entry">
        ...
        <td nowrap><p class="normal"><bean:write name="entry" property="categoryDescription"/></p></td>
        ...
        <tr>
        <td></td>
        <td colspan="2" nowrap><p class="normal"><bean:write name="entry" property="store"/></p></td>
        ...
        <td align="right" nowrap><erland-common:beanlink name="entry" property="deleteLink" style="bold-link" onClickMessageKey="diary.purchase.button.delete.are-you-sure"><bean:message key="diary.purchase.button.delete"/></erland-common:beanlink></td>
        <tr>
    </logic:iterate>
</table>

...
<html:form action="/user/editinventoryentryandevent" method="POST">
    ...
    <tr><td><bean:message key="diary.inventory.edit.event.description"/></td><td>
    <html:select property="eventDescriptionDisplay" size="1">
        <html:options collection="inventoryEntryEventTypesPB" property="idDisplay" labelProperty="description" />
    </html:select>
    </td></tr>
    <tr><td><bean:message key="diary.inventory.edit.event.date"/></td><td>
    <html:text property="eventDateDisplay"/>
    </td></tr>

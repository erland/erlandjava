...
I personally run the application in four different databases, but it might also
...
====================================
You will need to configure four JDBC datasources in your web-server
...
The datasources in my installation points to four different databases in the same
...
resources table in the database accessed as jdbc/common. You have to make sure that this

...
public class EditUserAccountAction extends BaseAction {
    protected void executeLogic(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        UserAccount account = (UserAccount) getEnvironment().getEntityFactory().create("diary-useraccount");
        PropertyUtils.copyProperties(account, fb);
        getEnvironment().getEntityStorageFactory().getStorage("diary-useraccount").store(account);
    }
}

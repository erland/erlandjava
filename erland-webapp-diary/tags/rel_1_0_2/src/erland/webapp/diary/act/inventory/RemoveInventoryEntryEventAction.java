...
public class RemoveInventoryEntryEventAction extends BaseAction {
    protected void executeLogic(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        entry.setEventId(fb.getEventId());
        getEnvironment().getEntityStorageFactory().getStorage("diary-inventoryentryevent").delete(entry);
    }
}

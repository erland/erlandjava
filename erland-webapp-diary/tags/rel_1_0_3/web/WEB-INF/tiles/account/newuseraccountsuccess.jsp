...
<table>
    ...
    <tr>
    <td><bean:message key="diary.account.new.firstname"/></td>
    <td><bean:write name="accountPB" property="firstName"/></td>
    </tr>
    <tr>
    <td><bean:message key="diary.account.new.lastname"/></td>
...
<form name="loginForm" action="j_security_check" method="POST">
    ...
    <tr><td><bean:message key="diary.login.password"/></td><td>
    <input type="password" name="j_password" value="">
    </td></tr>
    <tr><td></td><td>
    <input type="submit" value="<bean:message key="diary.login.button"/>">
    </td></tr>
    </table>
</form>

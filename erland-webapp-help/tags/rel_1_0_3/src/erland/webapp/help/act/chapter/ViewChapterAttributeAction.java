...
public class ViewChapterAttributeAction extends BaseAction {
    protected void executeLogic(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        ChapterAttribute attribute = (ChapterAttribute) getEnvironment().getEntityStorageFactory().getStorage("help-chapterattribute").load(template);
        PropertyUtils.copyProperties(fb, attribute);
    }
}

...
public class SearchOfficialCollectionEntriesAction extends SearchCollectionEntriesAction {
    protected boolean isAllowed(Collection collection, String user) {
        return collection.getOfficial()!=null && collection.getOfficial().booleanValue();    
    }
}
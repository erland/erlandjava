...
<p class="propertypage-title"><bean:message key="dirgallery.account.new.title"/></p>
<p class="propertypage-notice"><bean:message key="dirgallery.account.new.mandatory-text"/></p>

...
public class MovieThumbnail implements ControllerListener, DataSinkListener {
    ...
    public BufferedImage create(URL movie, int noOfColumns, int noOfRows, int width) {
        synchronized (sync) {
            MediaLocator ml;
    ...
    public static void main(String[] args) {
        try {
            ...
            MovieThumbnail me = new MovieThumbnail();
            BufferedImage image = me.create(url, 4, 2, 600);
            if (image != null) {

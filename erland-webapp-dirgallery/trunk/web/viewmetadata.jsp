<%@ page import="erland.webapp.common.CommandInterface,
                 ...
                 erland.webapp.dirgallery.loader.ViewMetadataInterface"%>
<%
    ...
    if(cmd instanceof ViewMetadataInterface) {
        ...
        if(showAll!=null && showAll.equalsIgnoreCase("true")) {
            %>
            <br><a class="bold-link" href="portal?<%=ServletParameterHelper.removeParameter(request.getAttribute("cmdparameters").toString(),"showall")%>">Visa endast utvald extra bildinformation</a>
            <%
        }else {
            %>
            <br><a class="bold-link" href="portal?<%=ServletParameterHelper.replaceParameter(request.getAttribute("cmdparameters").toString(),"showall","true")%>">Visa all extra bildinformation</a>
            <%
        }
        %>
        <%

...
<body class="layout">
<center>
<table class="layout-main" border="0" cellspacing="0" cellpadding="0" width="500" height="100%">
...
<logic:notEmpty name="menu">
  <td class="layout-body-menu" width="140" height="100%" valign="top">
    <tiles:insert attribute='menu' />
  </td>
</logic:notEmpty>
<tiles:useAttribute name="body" ignore="true" />
<logic:notEmpty name="body">
  <td class="layout-body-content" valign="top" height="100%" align="left">

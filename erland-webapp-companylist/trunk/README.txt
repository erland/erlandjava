...
2. LIBRARIES
============
This softaware also includes the struts library, see
http://jakarta.apache.org/struts for more information
...
- companylist.war (The web application code)
...
- companylist.sql
  Creates the tables needed in the database which will be accessed as jdbc/companylist
- users.sql
...
jdbc/companylist: Should have the tables defined in the file(database\companylist.sql)
...
in the resources table in the database accessed as jdbc/common. You have to make sure that

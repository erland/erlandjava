...
<logic:notEmpty name="accountValuePB" >
    <img src="<html:rewrite page="/do/accountdiagram"/>?accountId=<bean:write name="accountDiagramFB" property="accountId"/>&broker=<bean:write name="accountDiagramFB" property="broker"/>&stock=<bean:write name="accountDiagramFB" property="stock"/>&startDateDisplay=<bean:write name="accountDiagramFB" property="startDateDisplay"/>&endDateDisplay=<bean:write name="accountDiagramFB" property="endDateDisplay"/>"></img>
    <br>
...
<logic:empty name="accountValuePB" >
    ...
    <form name="showAccount" action="portal" method="POST">
            ...
            <tr><td></td><td><a href="javascript: window.location='<html:rewrite page="/do/viewaccountdiagram"/>?accountId=<bean:write name="accountDiagramFB" property="accountId"/>&startDateDisplay='+document.showAccount.startDateDisplay.value+'&endDateDisplay='+document.showAccount.endDateDisplay.value" class="diagrampage-button"><bean:message key="stock.account.diagram.view-all"/></a></td></tr>
    </form>
    </table>
</logic:empty>

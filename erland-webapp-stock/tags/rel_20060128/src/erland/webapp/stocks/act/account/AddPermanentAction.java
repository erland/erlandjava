...
public class AddPermanentAction extends BaseAction {
    public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws Exception {
        ...
        if(fb.getValue()!=null) {
            account.addStockPermanentForPrice(fb.getBroker(),fb.getStock(),fb.getPurchaseDate(),fb.getNumber().doubleValue(),fb.getValue().doubleValue());
        }else {
            account.addStockPermanent(fb.getBroker(),fb.getStock(),fb.getPurchaseDate(),fb.getNumber().doubleValue());
        }

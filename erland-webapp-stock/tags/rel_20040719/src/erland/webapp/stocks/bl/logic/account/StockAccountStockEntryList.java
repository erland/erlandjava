package erland.webapp.stocks.bl.logic.account;
/*
...
public class StockAccountStockEntryList implements StockAccountStockEntryListInterface {
    ...
    public StockAccountStockEntry[] toArray() {
        return (StockAccountStockEntry[]) stocks.toArray(new StockAccountStockEntry[0]);
    }
    public int size() {
        return stocks.size();
    }

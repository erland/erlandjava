...
public class AddSingleAction extends Action {
    public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws Exception {
        ...
        if(fb.getNumber()!=null && fb.getValue()!=null) {
            ...
            account.addStockSingle(fb.getBroker(),fb.getStock(),fb.getPurchaseDate(),fb.getNumber().doubleValue());
        }else if(fb.getValue()!=null) {
            account.addStockSingleForValue(fb.getBroker(),fb.getStock(),fb.getPurchaseDate(),fb.getValue().doubleValue());
        }else {

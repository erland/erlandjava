...
<logic:iterate name="brokersPB" id="broker">
    <tr><td nowrap>
    <a class="bold-link" href="<html:rewrite page="/do/newaccountpermanentnumberforvalue"/>?broker=<bean:write name="broker" property="id"/>"><bean:write name="broker" property="description"/> : <bean:message key="stock.account.add-permanent-number-for-value"/></a>
    </td></tr>
    <tr><td nowrap>
    <a class="bold-link" href="<html:rewrite page="/do/newaccountpermanentnumber"/>?broker=<bean:write name="broker" property="id"/>"><bean:write name="broker" property="description"/> : <bean:message key="stock.account.add-permanent-number"/></a>
    </td></tr>
</logic:iterate>
</table>
<table class="no-border">

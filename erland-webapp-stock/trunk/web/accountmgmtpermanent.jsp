...
<%
    ...
    if(account!=null) {
        ...
        while(it.hasNext()) {
            ...
            %>
            <tr><td><a class="bold-link" href="portal?do=stockaccountnewpermanent&number=&value=&broker=<%=broker%>&addcmd=stockaccountaddpermanent"><%=brokerString%> : Lägg till (antal aktier för värde)</a></td></tr>
            <tr><td><a class="bold-link" href="portal?do=stockaccountnewpermanent&number=&broker=<%=broker%>&addcmd=stockaccountaddpermanent"><%=brokerString%> : Lägg till (antal aktier)</a></td></tr>
            <%
        }
        %>
        </table>

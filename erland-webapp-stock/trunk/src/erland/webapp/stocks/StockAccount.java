...
public abstract class StockAccount implements StockAccountViewInterface, EntityInterface {
    ...
    abstract public boolean addStockContinously(String broker, String stock, String date, double valueOfStocks, String interval);

    abstract public boolean addStockSingle(String broker, String stock, String date, double numberOfStocks);

    abstract public boolean addStockSingleForValue(String broker, String stock, String date, double valueOfStocks);

    abstract public boolean addStockSingleForPrice(String broker, String stock, String date, double numberOfStocks, double priceOfStocks);

    abstract public boolean addStockPermanent(String broker, String stock, String date, double number);

    abstract public boolean addStockPermanentForPrice(String broker, String stock, String date, double number, double price);

    abstract public boolean removeStockContinously(String broker, String stock, String date);

    abstract public boolean removeStockSingle(String broker, String stock, String date);

    abstract public boolean removeStockPermanent(String broker, String stock, String date);

    abstract public StockAccountStockEntryListInterface getStocks();
    ...
    private DateValueSerie getStockValues(DateValueSerieInterface values, String broker, String stock, String fromDate, String toDate,SerieType type) {
        Log.println(this,"getStockValues start "+broker+" "+stock+" "+fromDate+" "+toDate+" "+System.currentTimeMillis());
        Date dateFrom = StockAccountTransactionList.getDateFromString(fromDate);
        Date dateTo = StockAccountTransactionList.getDateFromString(toDate);
        ...
        while(curPos<=finalEndPos) {
            ...
            if(currentMultiple!=null) {
                ...
                //Log.println(this,"find next multiple: "+dv.getDate()+" "+yearMultiple+" "+monthMultiple);
    ...
    public double getStockValue(String broker, String stock, String date) {
        Log.println(this,"getStockValue "+broker+" "+stock+" "+date);
        StockInterface s = stockStorage.getStock(broker,stock);
        double noOfStocks = getStockValue(s.getRates(),broker,stock,StockAccountTransactionList.getDateFromString(date),SerieType.STOCK_VALUES);
        int i = s.getRates().indexOf(StockAccountTransactionList.getDateFromString(date));
        if(i>=0) {
    ...
    public double getPurchaseValue(String broker, String stock, String date) {
        Log.println(this,"getPurchaseValue "+broker+" "+stock+" "+date);
        StockInterface s = stockStorage.getStock(broker,stock);
        return getStockValue(s.getRates(),broker,stock,StockAccountTransactionList.getDateFromString(date),SerieType.PURCHASE_VALUES);
    }

    public DateValueSerie getStockNumbers(String broker, String stock, String fromDate, String toDate, String serieName) {
        return getStockNumbers(broker,stock,fromDate,toDate,serieName,SerieType.STOCKNUMBER_VALUES);
    }
    public DateValueSerie getStockNumberDiffs(String broker, String stock, String fromDate, String toDate, String serieName) {
        return getStockNumbers(broker,stock,fromDate,toDate,serieName,SerieType.STOCKNUMBERDIFF_VALUES);
    }

    private DateValueSerie getStockNumbers(String broker, String stock, String fromDate, String toDate, String serieName, SerieType type) {
        ...
        dateValues.setName(environment.getBrokers().getStockName(broker,stock)+" "+serieName);
        return dateValues;
    }

    public DateValueSerie getStockValues(String broker, String stock, String fromDate, String toDate) {
        ...
        dateValues.setName(environment.getBrokers().getStockName(broker,stock));
        return dateValues;
    }

    private DateValueSerie getPurchaseValues(String broker, String stock, String fromDate, String toDate, String purchaseName, SerieType type) {
        Log.println(this,"getStockValues "+broker+" "+stock+" "+fromDate+" "+toDate);
        StockInterface s = stockStorage.getStock(broker,stock);
        DateValueSerieInterface values = s.getRates();
        DateValueSerie dateValues = getStockValues(values,broker,stock,fromDate,toDate, type);
        dateValues.setName(environment.getBrokers().getStockName(broker,stock)+" "+purchaseName);
        return dateValues;
    }

    public DateValueSerie getPurchaseValues(String broker, String stock, String fromDate, String toDate, String purchaseName) {
        return getPurchaseValues(broker, stock, fromDate, toDate, purchaseName, SerieType.PURCHASE_VALUES);
    }

    public DateValueSerie getPurchaseDiffValues(String broker, String stock, String fromDate, String toDate, String purchaseName) {
        return getPurchaseValues(broker, stock, fromDate, toDate, purchaseName, SerieType.PURCHASEDIFF_VALUES);
    }

    public DateValueSerie getTotalStockValues(String broker, String fromDate, String toDate) {
        Log.println(this,"getStockValues "+fromDate+" "+toDate);
        Vector subresult = new Vector();
        StockAccountStockEntryListInterface stocks = getStocks();
        for(int i=0;i<stocks.size();i++) {
            StockAccountStockEntry entry = stocks.getStock(i);
    ...
    public DateValueSerie getTotalPurchaseValues(String broker, String fromDate, String toDate, String purchaseName) {
        Log.println(this,"getStockValues "+fromDate+" "+toDate);
        Vector subresult = new Vector();
        StockAccountStockEntryListInterface stocks = getStocks();
        for(int i=0;i<stocks.size();i++) {
    ...
    private Vector getStockNumbers(String broker, String fromDate, String toDate, String serieName, SerieType type) {
    ...
    public Vector getStockNumbers(String broker, String fromDate, String toDate, String serieName) {
        return getStockNumbers(broker, fromDate, toDate, serieName, SerieType.STOCKNUMBER_VALUES);
    }
    public Vector getStockNumberDiffs(String broker, String fromDate, String toDate, String serieName) {
        return getStockNumbers(broker, fromDate, toDate, serieName, SerieType.STOCKNUMBERDIFF_VALUES);
    }
    public Vector getStockValues(String broker, String fromDate, String toDate) {
        Log.println(this,"getStockValues "+fromDate+" "+toDate);
        Vector result = new Vector();
        StockAccountStockEntryListInterface stocks = getStocks();
        for(int i=0;i<stocks.size();i++) {
    ...
    private Vector getPurchaseValues(String broker, String fromDate, String toDate, String purchaseName, SerieType type) {
        Log.println(this,"getStockValues "+fromDate+" "+toDate);
        Vector result = new Vector();
        StockAccountStockEntryListInterface stocks = getStocks();
        for(int i=0;i<stocks.size();i++) {
    ...
    public Vector getPurchaseValues(String broker, String fromDate, String toDate, String purchaseName) {
        return getPurchaseValues(broker, fromDate, toDate, purchaseName, SerieType.PURCHASE_VALUES);
    }

    public Vector getPurchaseDiffValues(String broker, String fromDate, String toDate, String purchaseName) {
    ...
    public double getStockValue(String broker, String date) {
    ...
    public double getPurchaseValue(String date) {
        return getPurchaseValue(null,date);
    }
    public double getPurchaseValue(String broker, String date) {

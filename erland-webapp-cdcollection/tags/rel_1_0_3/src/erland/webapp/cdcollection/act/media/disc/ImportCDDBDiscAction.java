...
import erland.webapp.cdcollection.fb.media.disc.DiscCDDBSearchFB;
...
public class ImportCDDBDiscAction extends BaseAction {
    protected void executeLogic(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        DiscCDDBSearchFB fb = (DiscCDDBSearchFB) form;
        DiscHelper.importDiscToMedia(fb.getMediaId(),fb.getCategory(),fb.getDiscId());
        request.setAttribute("media",fb.getMediaId());
    }
}
...
public class EditMediaAction extends BaseAction {
    protected void executeLogic(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        PropertyUtils.copyProperties(media, fb);
        getEnvironment().getEntityStorageFactory().getStorage("cdcollection-media").store(media);
        request.setAttribute("media",media.getId());
    }
}

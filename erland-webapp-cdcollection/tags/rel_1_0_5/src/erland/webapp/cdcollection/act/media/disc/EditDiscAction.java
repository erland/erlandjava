...
public class EditDiscAction extends BaseAction {
    protected void executeLogic(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        DiscFB fb = (DiscFB) form;
        Disc disc = (Disc) getEnvironment().getEntityFactory().create("cdcollection-disc");
        PropertyUtils.copyProperties(disc, fb);
        getEnvironment().getEntityStorageFactory().getStorage("cdcollection-disc").store(disc);
    }
}

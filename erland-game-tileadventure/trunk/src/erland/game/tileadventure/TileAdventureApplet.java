 ...
 */
public class TileAdventureApplet extends Applet implements GamePanelHandlerApplicationInterface, Runnable {
    ...
    public void run() {
        ...
        if(mayScript!=null) {
            storage = new ParameterStorageString(
                    new CookieStorage(this,"tileadventure"),
                    new JarFileStorage("TileAdventure.xml"),
                    "tileadventure");
        }
        ...
        handler.setCustomEnvironment(new RectEnvironment(handler));

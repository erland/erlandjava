...
public class WorldGameLevelManager extends LevelManager {
    ...
    public LevelInfoInterface createLevel(int level) {
        // No new levels can be created with this level manager
        return null;
    }
    ...
    public LevelInfoInterface getLevel(int level) {
        ...
        if (roomStorage != null) {
            ...
            LevelManager roomLevelManager = new RoomGameLevelManager();
            roomLevelManager.init(getEnvironment());
            roomLevelManager.setContainer(getContainer());
            ...
            while (!bEnd) {
                ...
                if (objectStorage != null) {
                    ...
                    LevelInfoInterface objectInfo = roomLevelManager.getLevel(obj.getBlockType());
                    RoomObject room = new RoomObject();
                    room.init(getEnvironment());

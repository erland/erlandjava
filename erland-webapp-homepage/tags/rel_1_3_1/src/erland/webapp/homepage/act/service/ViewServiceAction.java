...
public class ViewServiceAction extends BaseAction {
    protected void executeLogic(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        Service template = (Service) getEnvironment().getEntityFactory().create("homepage-service");
        template.setId(fb.getId());
        Service service = (Service) getEnvironment().getEntityStorageFactory().getStorage("homepage-service").load(template);

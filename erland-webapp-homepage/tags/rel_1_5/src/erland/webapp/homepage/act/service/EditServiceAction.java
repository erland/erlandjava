...
public class EditServiceAction extends BaseAction {
    ...
    protected void executeLogic(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        Service service = (Service) getEnvironment().getEntityFactory().create("homepage-service");
        PropertyUtils.copyProperties(service, fb);
        getEnvironment().getEntityStorageFactory().getStorage("homepage-service").store(service);
    }
}
